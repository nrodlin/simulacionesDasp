...
AOExpTime = 30.# (use --iterations=xxx to modify)--> texp = tstep * AOExpTime
# ============================ TELESCOPE DATA ============================================================
...
atmosDict={}
nlayer=4 # atmospheric layers
strList = [ 0.8,0.1,0.05,0.05] # strength list [1.0]#
hList=[0,5000,7000,12000] # height list [0]#
vList=[5.6,6.25,7.57,19.06] # wind speed list [5.6]#
